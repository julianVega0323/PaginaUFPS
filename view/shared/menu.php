...
<div id="menu-principal" class="header-v6 header-white-transparent header-sticky" style="position: relative;">
            ...
            <div class="parallax-quote-in" style="padding: 0px;">
                <div class="row">
                    <div class="col-md-4 col-sm-4 col-xs-5">
                        <a href="?">
                            <img id="logo-header" src="assets/img/logo_ufps.png" alt="Logo UFPS">
                        </a>
                    </div>
                    <div class="col-md-2 col-ms-1 col-xs-2 pull-right">
                        <a href="http://www.colombia.co/"><img class="header-banner" src="assets/img/escudo_colombia.png" alt="Escudo de Colombia"></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="menu-responsive">
        ...
        <a class="logo logo-responsive" href="index.html">
            <img src="assets/img/horizontal_logo_pequeno.png" alt="Logo">
        </a>  
        <!-- End Logo -->
    ...
    $categorias = $objCategoria->read();
    $numCategoria = count($objCategoria->read()) / 2;
                    ...
                    <li class="dropdown">
                        <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                    <li class="menu">
                                        <a href="javascript:void(0);">SubCategoria </a>
                                    </li>
                            </ul>
                    </li>
                <?php
