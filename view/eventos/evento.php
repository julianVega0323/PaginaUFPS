...
<div class="container content profile">
  ...
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active" aria-current="page">Eventos</li>
      ...
      <br><div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom:20px; border-bottom: 3px solid #aa1916; padding: 0;">
                <h1 class="pull-left" style="font-size:36px;">Eventos Comercio Internacional</h1>
              </div><br><br> 

              <?php 
                        for ($i=0; $i <$num ; $i++) { 
                           echo ' <div class="items-row cols-43 row-0">

                <div class="item-information column-1">
                        <h1 class="tituloinformacion">
                         <a class="tituloGaleria" href="./index.php?modulo=detallegaleria&idtipog=0&idgale=43">'.$evento[$i]['titulo'].'</a>                 
                          </h1> <br>
                         <div class="" style="float: left;">

                                <a href="./index.php?modulo=detallegaleria&idtipog=0&idgale=43"><img class="imgInformacion" src="'.$evento[$i]['url'].'" alt=""/>
                                </a>                
                          </div>
                          <div class="float_content">'.$evento[$i]['texto'].' </div>
                          <span>
                                <b>Fecha :</b>
                                <div style="float: right;" class="easy-block-v1-badge rgba-red">'.$evento[$i]['fecha'].'</div>
                          </span>
                            <span class="row-separator"></span>       </div>       </div><br><br><br><br>';
                        }
               ?>
